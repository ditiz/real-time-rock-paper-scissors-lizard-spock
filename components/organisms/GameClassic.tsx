...
import { GameClassicOptions, playGame } from "@/utils/game"
import { useEffect, useState } from "react"
import { Socket } from "socket.io-client"
import { GameTitleAtom } from "../atoms"
import { GameOptionMolecule, GameResultMolecule } from "../molecules"

interface GameClassicOrganismProps {
  socket: Socket
}

const GameClassicOrganism: React.FC<GameClassicOrganismProps> = ({
  socket,
}) => {
...
export default GameClassicOrganism
